---
title: 'Use cases: Client-side libraries'
excerpt: ''
deprecated: false
hidden: false
metadata:
...
* Enriching guest profile data

Continue reading to learn more about these use cases.

## Display a custom confirmation message

By default, after a guest has successfully scheduled a booking through your booking page, they will see a confirmation page that displays information about their booking.

If you want to display a custom confirmation message using booking confirmation data to your guests, you can do so in several different ways:

* Automatically redirect guests to your own custom confirmation page
...
Your custom confirmation message can include details about the booking that was just scheduled, as well as guest information submitted via the booking form.
...
* Sending a custom confirmation email to your guests after scheduling

OnceHub client-side integrations allow you to provide a seamless experience to your guests .

## Enrich guest profile data

A robust and integrated guest profile is essential to effective marketing analytics. By enriching your guest data repository with high-value personal information provided at the time of booking, you can present more relevant, timely, and personalized marketing to your leads and customers.
