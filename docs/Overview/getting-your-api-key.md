...
<Image alt={3358} border={false} caption="Figure 1: API key in the API integration page" title="API key in the API integration page.png" src="https://files.readme.io/2d6ddc4-API_key_in_the_API_integration_page.png" />

You can easily copy the API key from the API integration page to use when authenticating your HTTP requests in the API:

<Image alt={3358} border={false} caption="Figure 2: API key - Copy link" title="API key - Copy link.png" src="https://files.readme.io/ccb40ac-API_key_-_Copy_link.png" />
