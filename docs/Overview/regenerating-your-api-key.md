...
You can do so by clicking on the Regenerate link in <a target="_blank" href="https://app.oncehub.com/scheduleonce/Integration-API.aspx">ScheduleOnce > Setup > Integrations > API Integration</a>. 
