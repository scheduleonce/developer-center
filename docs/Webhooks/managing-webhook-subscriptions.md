...
<Image alt={1918} border={false} caption="Figure 1: API integration - Webhook subscription list" title="API integration - Webhook subscription list.png" src="https://files.readme.io/852d690-API_integration_-_Webhook_subscription_list.png" />