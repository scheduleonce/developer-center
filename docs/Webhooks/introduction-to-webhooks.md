...
The OnceHub Webhooks API is used to communicate with third-party web services. Webhook subscriptions are configured with a POST URL and an array of User-specified [event triggers](https://developers.oncehub.com/docs/webhook-event-triggers) representing different booking lifecycle events. 
...
<Image title="API Integration page with navigation menu.png" alt={3360} src="https://files.readme.io/bd3d3b3-API_Integration_page_with_navigation_menu.png">
  Figure 1: API Integration page with navigation menu
</Image>
