...
## Integrate ScheduleOnce with your application
...
## Use case: Updating your application with ScheduleOnce booking data

You can use Webhooks to streamline the scheduling experience for Users within your own application environment. By integrating ScheduleOnce with your application, your Users can simply send [personalized ScheduleOnce booking links](https://developers.scheduleonce.com/v1.0.0/docs/send-data-to-scheduleonce-via-url-parameters) to prospective customers, and automatically store and display all corresponding booking and meeting information within your own application. This integration will simply the workflow for your Users and provide a streamlined experience for your Customers.
...
## Use case: Analyze booking behavior
...
## Use case: Create new records in a CRM
...
![2874](https://files.readme.io/83f44cd-Screen_Shot_2018-04-01_at_4.33.30_PM.png "Screen Shot 2018-04-01 at 4.33.30 PM.png")
...
## Use case: Trigger a targeted email marketing campaign
...
![2872](https://files.readme.io/72d503b-Screen_Shot_2018-04-02_at_8.17.17_AM.png "Screen Shot 2018-04-02 at 8.17.17 AM.png")
