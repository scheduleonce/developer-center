...
[block:api-header]
{
  "title": "Using your API key to authenticate HTTP requests"
}
[/block]
...
{
  "type": "warning",
  "body": "Your API key carries many privileges, so be sure to keep it secret! Do not share your secret API key in publicly accessible areas such as GitHub, client-side code, and so forth.",
